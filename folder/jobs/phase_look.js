...
function PhaseLook(indek_parent){
  ...
  function select(indek,a){
    ...
    switch(bingkai[indek_parent].menu.id){
      case "jobs":
        Jobs.setPhase(indek_parent,data[a]);
        break;
        
      default:
        alert('['+bingkai[indek_parent].menu.id+']'
        +' undefined in [phase_look.js]');
    }
    ui.CLOSE_POP(indek);
  }
